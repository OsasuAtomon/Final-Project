...
<body onload="displayBanner('<?php  if($user == null){echo('New');} else{echo($user->username);} ?>') ">
    ...
    <h1 class="head-text"><?php echo($name);?></h1>
        <!-- <div id="recommended">
       <div class="product">
        ...
        <div class="product">
                    ...
                    <form action="index.php" method="POST">
                            <div class="class-shadow">
                                <div>
                                    <img src="./productimage/product1.jpg" alt="image1"  id="img1">
                                </div>
                                <div class="card-body">
                                    <center><h5 class="card-title">product1</h5></center>
                                    <center>
                                        <h6 class="">
                                   ...
                                   <div class="card-text">
                                   <p >
                                    Required. The horizontal offset of the shadow. 
