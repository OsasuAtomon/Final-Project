...
function home(id){
    ...
    location.href = "http://localhost/newphp/shop/?id="+id;
...
function viewProduct(product, username){
   var navigation = window.location.href.split('?');
    location.href = navigation[0]+"product.php?id="+product +"&username="+username;
...
function makePayment(userId, userName){
    var navigation = window.location.href.split('?');
    location.href = navigation[0]+"cashout.php?id="+userId+"&username="+userName;
}
